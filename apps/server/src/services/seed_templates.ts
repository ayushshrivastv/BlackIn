...
export async function seedTemplates() {
    const templates: Prisma.TemplateCreateInput[] = [
        ...
        {
            id: 'c42ac924-4f59-4f66-bfc8-df17ef2bb4f6',
            title: 'Base App Starter',
            description:
                'Single-prompt Base starter with React frontend, Solidity contracts, and CRE-ready deployment flow.',
            category: 'base-app',
            chain: 'BASE',
            tags: ['base', 'onchainkit', 'foundry', 'cre', 'starter'],
            baseNetwork: 'base-sepolia',
            frontendStack: 'OnchainKit',
            runtimeStack: 'CRE',
            imageUrl: 'https://d3k5vke5jsl4rb.cloudfront.net/images/contract-1.jpg',
            summarisedObject: JSON.stringify([
                {
                    id: 'apps/web/app/page.tsx',
                    path: 'apps/web/app/page.tsx',
                    type: 'frontend_entry',
                    content: {
                        description: 'Next.js + OnchainKit entrypoint for Base-native UI.',
                    },
                },
                {
                    id: 'contracts/src/BaseApp.sol',
                    path: 'contracts/src/BaseApp.sol',
                    type: 'solidity_contract',
                    content: {
                        description: 'Core Solidity contract for Base deployment.',
                    },
                },
                {
                    id: 'contracts/script/DeployBaseApp.s.sol',
                    path: 'contracts/script/DeployBaseApp.s.sol',
                    type: 'deploy_script',
                    content: {
                        description: 'Foundry deployment script for Base Sepolia.',
                    },
                },
            ]),
        },

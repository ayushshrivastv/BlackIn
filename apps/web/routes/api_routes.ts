...
const internalBackendBase = process.env.INTERNAL_BACKEND_URL?.replace(/\/+$/, '') ?? publicBackendBase;
const backendBase = typeof window === 'undefined' ? internalBackendBase : publicBackendBase;
